         ...
         <div className="group relative overflow-hidden rounded-[2rem] bg-brand text-white py-5 px-8 shadow-2xl shadow-brand/20 border border-brand/10 transition-all duration-700 hover:shadow-brand/30">
           ...
           <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
             ...
             <div className="flex-shrink-0 flex items-center gap-3 animate-in fade-in slide-in-from-right-10 duration-1000 delay-300">
               ...
               <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-xl bg-card/10 border border-white/10 text-[10px] font-black backdrop-blur-xl shadow-inner text-white transition-all duration-500 hover:bg-card/20 hover:scale-105 cursor-default">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-in fade-in slide-in-from-bottom-2 duration-700 delay-300">
           ...
           >
             ...
             <div className="relative z-10 mt-6 flex items-center justify-between w-full">
               ...
               <div className="w-8 h-8 rounded-full bg-muted flex items-center justify-center group-hover:bg-brand group-hover:text-white transition-all">
           ...
           >
             ...
             <div className="relative z-10 mt-6 flex items-center justify-between w-full">
               ...
               <div className="w-8 h-8 rounded-full bg-muted flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all">
                 <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
               </div>
             </div>
           </button>
           ...
           <CreateCandidateButton className="p-0 border-none bg-transparent hover:bg-transparent shadow-none w-full h-full block">
             <div className="group relative flex flex-col items-start p-6 rounded-[2rem] bg-card border border-border shadow-sm hover:shadow-2xl hover:shadow-brand/10 hover:border-brand/20 transition-all duration-500 text-left h-full overflow-hidden">
               ...
               <div className="relative z-10 mt-6 flex items-center justify-between w-full">
                 ...
                 <div className="w-8 h-8 rounded-full bg-muted flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-all">
                   <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
                 </div>
               </div>
             </div>
