    ...
    <div className="min-h-screen bg-muted/60">
      ...
      <div className="bg-card border-b sticky top-0 z-20">
        <div className="px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div>
              <h1 className="text-base font-semibold text-foreground">Assign Role to User</h1>
              {role && (
      ...
      <div className="px-6 py-6 max-w-3xl mx-auto space-y-4">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b bg-muted/80">
              ...
              {filtered.map((user) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={`text-sm font-medium truncate transition-colors ${isSelected ? "text-foreground" : "text-foreground"}`}
                      >
                        {displayName}
                      </p>
          ...
          {!loading && filtered.length > 0 && (
            <div className="px-5 py-3 border-t bg-muted/80">
              <p className="text-xs text-muted-foreground">
                {selectedUserId
