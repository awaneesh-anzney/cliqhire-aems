...
export function CandidateInfoGrid({ candidate }: { candidate: Candidate }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
      <div className="bg-card rounded-xl p-3.5 shadow-sm border border-border/60">
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Current Position</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Previous Company</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Experience</p>
      ...
      <div className="bg-card rounded-xl p-3.5 shadow-sm border border-border/60">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Phone</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Location</p>
      ...
      <div className="bg-card rounded-xl p-3.5 shadow-sm border border-border/60">
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Education</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Languages</p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-0.5">Skills</p>
