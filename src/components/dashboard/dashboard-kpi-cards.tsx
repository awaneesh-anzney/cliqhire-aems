...
export function DashboardKpiCards() {
    ...
    if (isLoading) {
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="dashboard-kpi-skeleton min-h-[160px]">
                    <div>
                ...
                <div className="dashboard-kpi-skeleton min-h-[160px]">
                    ...
                    <div className="grid grid-cols-3 gap-1.5 mt-3 pt-2.5 border-t border-muted/50">
                ...
                {/* 4. Pipeline Skeleton */}
                <div className="dashboard-kpi-skeleton min-h-[160px] md:col-span-2 lg:col-span-2">
                    <div>
                        <div className="flex justify-between items-start mb-3">
                            <div className="w-8 h-8 rounded-lg bg-muted animate-pulse" />
                            <div className="w-4 h-4 rounded bg-muted animate-pulse" />
                        </div>
                        <div className="h-3 w-28 bg-muted rounded mb-2 animate-pulse" />
                        <div className="h-7 w-16 bg-muted rounded animate-pulse" />
                    </div>
                    <div className="grid grid-cols-2 gap-3 mt-3 pt-2.5 border-t border-muted/50">
                ...
                <div className="flex flex-col md:flex-row lg:flex-col gap-4 md:col-span-2 lg:col-span-1">
                    {/* Team Users Skeleton */}
                    <div className="p-3.5 rounded-xl bg-card border border-border/60 shadow-sm flex flex-col justify-between animate-pulse flex-1 min-h-[75px]">
                        <div>
                            <div className="flex justify-between items-start mb-1.5">
                                <div className="h-2.5 w-12 bg-muted rounded animate-pulse" />
                                <div className="w-5 h-5 rounded bg-muted animate-pulse" />
                            </div>
                            <div className="h-5 w-8 bg-muted rounded mb-1.5 animate-pulse" />
                        </div>
                    ...
                    <div className="p-3.5 rounded-xl bg-card border border-border/60 shadow-sm flex flex-col justify-between animate-pulse flex-1 min-h-[75px]">
                        ...
                        <div className="h-4 bg-muted rounded mt-1.5 animate-pulse" />
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="group dashboard-kpi-card">
                ...
                <div>
                    <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="p-1.5 rounded-lg bg-brand/5 text-brand group-hover:bg-brand/10 group-hover:scale-105 transition-all duration-300">
            ...
            <div className="group dashboard-kpi-card">
                ...
                <div>
                    <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="p-1.5 rounded-lg bg-emerald-500/5 text-emerald-600 group-hover:bg-emerald-600/10 group-hover:scale-105 transition-all duration-300">
                ...
                <div className="mt-4 space-y-2">
                    ...
                    <div className="flex items-center justify-between text-[9px] font-bold text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1 text-sky-600 border-x border-border/40 px-1.5">
            ...
            <div className="group dashboard-kpi-card lg:col-span-2">
                ...
                <div>
                    <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="p-1.5 rounded-lg bg-blue-500/5 text-blue-600 group-hover:bg-blue-600/10 group-hover:scale-105 transition-all duration-300">
                    ...
                    <div className="flex items-baseline gap-1.5">
                        ...
                        <span className="text-[10px] font-semibold text-muted-foreground">candidates in funnel</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4 pt-3 border-t border-border/40">
                    <div className="flex flex-col justify-between space-y-1.5">
                        ...
                        <div className="flex items-center justify-between bg-orange-500/5 dark:bg-orange-500/10 px-3 py-1 rounded-lg border border-orange-500/10 text-[11px] font-bold text-orange-600">
                            <span>In Process</span>
                            <span>{candidatesInProcess}</span>
                        </div>
                        <div className="flex items-center justify-between bg-emerald-500/5 dark:bg-emerald-500/10 px-3 py-1 rounded-lg border border-emerald-500/10 text-[11px] font-bold text-emerald-600">
                            <span>Completed</span>
                ...
                <div className="group dashboard-kpi-card flex-1 p-3.5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <div className="p-1 rounded-lg bg-teal-500/5 text-teal-600 group-hover:bg-teal-655/10 transition-all duration-300">
                ...
                <div className="group dashboard-kpi-card flex-1 p-3.5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <div className="p-1 rounded-lg bg-pink-500/5 text-pink-600 group-hover:bg-pink-655/10 transition-all duration-300">
                        ...
                        <div className="flex items-baseline gap-1.5 my-0.5">
                            ...
                            <span className="text-[10px] font-bold text-muted-foreground">agreements</span>
                        </div>
                    </div>

                    <div className="mt-2">
                        <div className="flex items-center justify-between p-1 rounded-lg bg-pink-500/5 border border-pink-500/10 text-[9px] font-bold text-pink-600">
