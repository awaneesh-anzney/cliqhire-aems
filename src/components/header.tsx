      ...
      <div className="flex h-16 items-center px-4 md:px-6 gap-4 md:gap-6">
        {showMobileSearch ? (
          ...
          <>
            ...
            <div className="flex items-center gap-3">
              ...
              {isOnIdPage && (
                <Button
                  ...
                  size="sm"
                  onClick={handleBack}
                  className="flex items-center gap-2 text-muted-foreground font-black text-[11px] uppercase tracking-widest hover:text-brand hover:bg-brand/10 transition-all rounded-2xl px-4 h-10 border border-border hover:border-brand/20 bg-card shadow-sm"
                >
            ...
            <div className="hidden md:flex flex-1 justify-center max-w-2xl mx-auto animate-in fade-in slide-in-from-top-2 duration-500">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Button
                ...
                className="flex md:hidden rounded-xl hover:bg-muted text-muted-foreground h-9 w-9"
              >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <div className="flex items-center gap-3 pl-1 pr-1 py-1 rounded-2xl cursor-pointer group hover:bg-muted transition-all border border-transparent hover:border-border active:scale-[0.98]">
                    <Avatar className="h-9 w-9 md:h-10 md:w-10 ring-2 ring-transparent group-hover:ring-brand/30 transition-all shadow-md shrink-0">
