      ...
      <Dialog open={currentOpen} onOpenChange={setOpen}>
        <DialogContent className="max-w-4xl p-0 overflow-hidden border-none shadow-2xl rounded-2xl h-[580px] flex flex-col">
          ...
          <div className="flex-1 flex overflow-hidden">
                          ...
                          >
                            ...
                            <div className="flex flex-col min-w-0 flex-1">
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-[9px] text-muted-foreground font-medium truncate flex-1">
                                  {candidate.email}
                                </span>
                              </div>
                            </div>
            ...
            <div className="w-[300px] bg-muted/50 p-6 flex flex-col shrink-0 border-l border-border">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar -mx-2 px-2 pb-4">
                {selectedCandidates.length > 0 ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center p-6 border-2 border-dashed border-border rounded-3xl opacity-50">
