      ...
      <SidebarHeader className="p-3.5 border-b border-border/70 shrink-0 bg-transparent">
        ...
        >
          ...
          <div className="relative flex shrink-0 items-center justify-center">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-primary via-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-primary/20 transition-transform duration-200 hover:scale-105 active:scale-95">
          ...
          <div className="flex flex-col min-w-0 group-data-[collapsible=icon]:hidden animate-in fade-in slide-in-from-left-2 duration-300">
            <div className="flex items-center gap-1.5">
              ...
              <span className="px-1.5 py-0.2 rounded-md bg-primary/10 text-primary text-[9px] font-bold border border-primary/20">
                OS
              </span>
            </div>
