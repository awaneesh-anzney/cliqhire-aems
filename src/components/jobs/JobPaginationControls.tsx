...
export function JobPaginationControls({
  ...
  const startItem = jobsLength > 0 ? (currentPage - 1) * pageSize + 1 : 0;
  const endItem = Math.min(currentPage * pageSize, totalJobs);

  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-3 py-2 text-xs select-none">
...
export default JobPaginationControls;
